          ...
          {({ open, close }) => (
            <>
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <Popover.Panel className="flex flex-col absolute sm:w-full lg:w-[calc(20vw-1rem)] pr-4 sm:pr-0   h-[calc(60vh-1rem)] z-30 inset-x-0 text-sm text-ui-fg-on-color m-2 backdrop-blur-2xl">
                  <div className="flex flex-col h-full bg-[rgba(3,7,18,0.5)] rounded-rounded justify-between p-6">
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between txt-compact-small">
                        © {new Date().getFullYear()} HONVIETSTORE. All rights
                        reserved.
                      </Text>
                    </div>
                  </div>
