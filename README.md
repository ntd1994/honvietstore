...
```
cd existing_repo
git remote add origin https://gitlab.com/luongtrieuvy202/medusa-storefront.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/luongtrieuvy202/medusa-storefront/-/settings/integrations)
